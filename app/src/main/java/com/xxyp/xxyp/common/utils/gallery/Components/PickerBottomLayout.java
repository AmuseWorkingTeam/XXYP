...
package com.xxyp.xxyp.common.utils.gallery.Components;

import com.xxyp.xxyp.R;
import com.xxyp.xxyp.common.utils.gallery.PhotoAlbumPickerActivity;
import com.xxyp.xxyp.common.utils.gallery.Theme;
...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        doneButtonBadgeTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
        ...
        doneButton.addView(doneButtonBadgeTextView,
                LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_VERTICAL, 0, 0, 10, 0));

        doneButtonTextView = new TextView(context);
        doneButtonTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 18);
