...
public abstract class PermissionsResultAction {
    ...
    protected synchronized final boolean onResult(final List<String> permissions,
            final int result) {
        XXLog.log_i(TAG, "onResult permissions length:" + permissions.size() + ":" + permissions
        ...
        switch (result) {
            case PermissionsConstant.GRANTED:
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        XXLog.log_i(TAG, "Permission is Granted: " + permissions);
                    }
                });
            ...
            case PermissionsConstant.DENIED:
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        XXLog.log_i(TAG, "Permission is Denied: " + permissions);
                    }
                });
                return true;
            case PermissionsConstant.NOT_FOUND:
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        onGranted(permissions);
                        XXLog.log_i(TAG, "Permission not found: " + permissions);
                    }
                });
                return true;
        }
