package com.xxyp.xxyp.common.utils.gallery.Actionbar;
...
import com.xxyp.xxyp.common.utils.gallery.AnimatorListenerAdapterProxy;
...
//                .setBackgroundDrawable(Theme.createBarSelectorDrawable(itemsBackgroundColor));
        LayoutParams params = LayoutHelper.createFrame(24, 24);
        params.gravity = Gravity.CENTER_VERTICAL;
        params.setMargins(AndroidUtilities.dp(8),0,0,0);
        backContainer.addView(backButtonImageView, params);
        addView(backContainer, LayoutHelper.createFrame(44, 44, Gravity.LEFT | Gravity.TOP));
    ...
    public void setBackButtonImage(int resource) {
        ...
        backButtonImageView.setBackgroundResource(R.drawable.album_ab_back);
    }
