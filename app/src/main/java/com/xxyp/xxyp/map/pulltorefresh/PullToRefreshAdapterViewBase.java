...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
    ...
    public PullToRefreshAdapterViewBase(Context context, AttributeSet attrs, Mode mode) {
        this(context, attrs, mode, AnimationStyle.getDefault());
    }

    public PullToRefreshAdapterViewBase(Context context, AttributeSet attrs, Mode mode,
                                        AnimationStyle animStyle) {
        super(context, attrs, mode, animStyle);
    ...
    public void setSelection(int scrollIndex) {
        mRefreshableView.setSelection(scrollIndex);
    }
}
