...
/**
 * Description : 聊天页面软键盘 Created by sunpengfei on 2017/8/1. Person in charge :
 * sunpengfei
 */
public class AutoComputerInputMethodHeightView extends LinearLayout {
    ...
    public AutoComputerInputMethodHeightView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
